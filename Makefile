...
pkgdatadir = $(datadir)/libfdf
pkgincludedir = $(includedir)/libfdf
pkglibdir = $(libdir)/libfdf
pkglibexecdir = $(libexecdir)/libfdf
...
am__aclocal_m4_deps = $(top_srcdir)/config/m4/ax_f90_module_case.m4 \
...
CONFIG_CLEAN_FILES = config/data/libfdf-config.yml \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(top_srcdir)/config/data/libfdf-config.yml.in \
	$(top_srcdir)/config/data/libfdf.pc.in \
	$(top_srcdir)/config/gnu/compile \
	...
	$(top_srcdir)/config/gnu/missing AUTHORS COPYING ChangeLog \
	INSTALL NEWS README config/gnu/compile config/gnu/config.guess \
...
ACLOCAL = ${SHELL} '/home/ravindra/devel/io08/modified-libfdf/config/gnu/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = gcc-ar
AUTOCONF = ${SHELL} '/home/ravindra/devel/io08/modified-libfdf/config/gnu/missing' autoconf
AUTOHEADER = ${SHELL} '/home/ravindra/devel/io08/modified-libfdf/config/gnu/missing' autoheader
AUTOMAKE = ${SHELL} '/home/ravindra/devel/io08/modified-libfdf/config/gnu/missing' automake-1.16
AWK = gawk
CC = icc
...
LTOBJEXT = lo
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} '/home/ravindra/devel/io08/modified-libfdf/config/gnu/missing' makeinfo
MANIFEST_TOOL = :
...
OTOOL64 = 
PACKAGE = libfdf
PACKAGE_BUGREPORT = https://bugs.launchpad.net/libfdf
PACKAGE_NAME = LibFDF
PACKAGE_STRING = LibFDF 0.2.2
PACKAGE_TARNAME = libfdf
PACKAGE_URL = https://launchpad.net/libfdf
...
STRIP = strip
VERSION = 0.2.2
abs_builddir = /home/ravindra/devel/io08/modified-libfdf
abs_srcdir = /home/ravindra/devel/io08/modified-libfdf
abs_top_builddir = /home/ravindra/devel/io08/modified-libfdf
abs_top_srcdir = /home/ravindra/devel/io08/modified-libfdf
ac_ct_AR = 
ac_ct_CC = icc
ac_ct_DUMPBIN = 
ac_ct_FC = 
...
enable_debug = 
exec_prefix = ${prefix}
fdf_cc_path = /home/ravindra/intel/oneapi/compiler/2021.1.1/linux/bin/intel64/icc
fdf_core_incs = 
fdf_debug_enable = no
fdf_debug_enable_def = no
fdf_debug_type = def
fdf_fc_path = /home/ravindra/intel/oneapi/compiler/2021.1.1/linux/bin/intel64/ifort
fdf_timestamp = 20210326T015251+0100
...
install_sh = ${SHELL} /home/ravindra/devel/io08/modified-libfdf/config/gnu/install-sh
...
config/data/libfdf-config.yml: $(top_builddir)/config.status $(top_srcdir)/config/data/libfdf-config.yml.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
config/data/libfdf.pc: $(top_builddir)/config.status $(top_srcdir)/config/data/libfdf.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
